package com.hanna.carritoapp.adapters
...
class ProductoAdapter (val productos:ArrayList<Prducto>) : RecyclerView.Adapter<ProductoAdapter.ViewHolder>() {
    var position: Int = -1
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(producto: Prducto) {
